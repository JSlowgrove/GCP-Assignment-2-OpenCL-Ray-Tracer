...
void Texture::pushToScreen(SDL_Renderer* renderer, glm::vec2 pos)
{
...
void Texture::pushToScreen(SDL_Renderer* renderer, glm::vec2 pos, glm::vec2 scale)
{
	//Create the destination rectangle of the texture
	SDL_Rect destRect;
	destRect.x = (int)pos.x;
...
void Texture::pushSpriteToScreen(SDL_Renderer* renderer, glm::vec2 pos, glm::vec2 spritePos, glm::vec2 spriteDimensions)
{
	//Create the destination rectangle of the texture
	SDL_Rect destRect;
	destRect.x = (int)pos.x;
...
void Texture::pushSpriteToScreen(SDL_Renderer* renderer, glm::vec2 pos, glm::vec2 scale, glm::vec2 spritePos, glm::vec2 spriteDimensions)
{
	//Create the destination rectangle of the texture
	SDL_Rect destRect;
	destRect.x = (int)pos.x;
...
void Texture::setColourTint(int r, int g, int b)
{
